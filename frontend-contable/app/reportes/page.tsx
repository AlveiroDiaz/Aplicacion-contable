...
type Tab = "libro_mayor" | "nuevo";

export default function ReportesPage() {
  const [tab, setTab] = useState<Tab>("libro_mayor");
    ...
    <div className="mx-auto max-w-5xl p-6">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Consulta el libro mayor y futuros reportes contables.
        </p>
      </div>

      <div className="mb-6 flex items-center gap-2">
        <button
          onClick={() => setTab("libro_mayor")}
        ...
        <button
          onClick={() => AlertService.info("Próximamente")}
          className="rounded-xl px-4 py-2 text-sm font-medium text-gray-500 transition hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800"
        >
          Próximamente
        </button>
      </div>
